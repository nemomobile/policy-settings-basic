%   ActiveGroup  GroupToCork    State
%   ------------------------------------
cork( navigator  , alwayson   , uncorked).
cork( navigator  , nonsilent  , uncorked).
...
cork( navigator  , alarm      , uncorked).
cork( navigator  , game       , uncorked).
cork( navigator  , player     , uncorked).
...
cork( videoeditor, nonsilent  , uncorked).
...
cork( videoeditor, alarm      , uncorked).
cork( videoeditor, game       , uncorked).
cork( videoeditor, player     , uncorked).
...
cork( camera     , nonsilent  , uncorked).
...
cork( ringtone   , nonsilent  , uncorked).
...
cork( player     , nonsilent  , uncorked).
...
cork( othermedia , nonsilent  , uncorked).
...
cork( background , nonsilent  , uncorked).
